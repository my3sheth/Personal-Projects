# -*- coding: utf-8 -*-
"""IMDb Top 1,000 Movies Analysis

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1MCqOD8mr673TaPBKwVsbZsjKK-5zPIqO

##View deployment on: https://my3-imdb-movies-analysis.streamlit.app/
...
def plot_model_scores(scores):
    ...
    plt.tight_layout()
    st.pyplot(plt.gcf())  # Show plot in Streamlit
...
def plot_ann_loss(history):
    ...
    plt.legend()
    plt.tight_layout()
    plt.show()  # Use this outside Streamlit
